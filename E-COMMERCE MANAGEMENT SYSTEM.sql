...
------------------------------------------------------------------------------------------------------------------------
CREATE DATABASE TRAVEL_BOOKING_TABLE
USE TRAVEL_BOOKING_TABLE
CREATE TABLE Travel_Bookings (
    booking_id INT AUTO_INCREMENT PRIMARY KEY,
    passenger_id INT NOT NULL,
    travel_type ENUM('Flight','Train','Bus','Cab','Tour'),
...
INSERT INTO Passengers (full_name, age, gender, phone, email, address) VALUES
('Arun Kumar', 28, 'Male', '9000000001', 'arun.kumar@mail.com', 'Chennai'),
('Priya Sharma', 25, 'Female', '9000000002', 'priya.sharma@mail.com', 'Coimbatore'),
('Dhanush R', 30, 'Male', '9000000003', 'dhanush.r@mail.com', 'Erode'),
('Meena Lakshmi', 22, 'Female', '9000000004', 'meena.lakshmi@mail.com', 'Salem'),
('Karthik Subramani', 34, 'Male', '9000000005', 'karthik.s@mail.com', 'Madurai'),
('Rajesh Kumar', 29, 'Male', '9000000006', 'rajesh.k@mail.com', 'Tirunelveli'),
('Sneha Priya', 26, 'Female', '9000000007', 'sneha.priya@mail.com', 'Trichy'),
('Vignesh P', 32, 'Male', '9000000008', 'vignesh.p@mail.com', 'Vellore'),
('Harini S', 24, 'Female', '9000000009', 'harini.s@mail.com', 'Chennai'),
('Ravi Teja', 27, 'Male', '9000000010', 'ravi.teja@mail.com', 'Hyderabad');
INSERT INTO Travel_Bookings 
(passenger_id, travel_type, travel_date, source, destination, seat_no, booking_status)
VALUES
(1, 'Train',  '2025-01-12', 'Chennai',      'Bangalore',     'A1', 'Confirmed'),
(2, 'Flight', '2025-02-05', 'Coimbatore',   'Delhi',         '12B', 'Pending'),
(3, 'Bus',    '2025-03-15', 'Erode',        'Chennai',       '15', 'Confirmed'),
(4, 'Train',  '2025-01-25', 'Salem',        'Madurai',       'C3', 'Cancelled'),
(5, 'Cab',    '2025-01-30', 'Madurai',      'Rameswaram',    NULL, 'Confirmed'),
(6, 'Train',  '2025-02-10', 'Tirunelveli',  'Chennai',       'B2', 'Pending'),
(7, 'Bus',    '2025-02-12', 'Trichy',       'Bangalore',     '18', 'Confirmed'),
(8, 'Flight', '2025-03-01', 'Chennai',      'Mumbai',        '7A', 'Confirmed'),
(9, 'Train',  '2025-01-20', 'Chennai',      'Coimbatore',    'D4', 'Confirmed'),
(10,'Bus',    '2025-01-18', 'Hyderabad',    'Chennai',       '22', 'Cancelled');

-- SELECT ALL BOOKINGS WITH PASSENGER NAMES 

SELECT b.booking_id, p.full_name AS passenger_name, 
       b.seat_no, b.booking_status,b.travel_date
FROM Travel_Bookings b
INNER JOIN Passengers p 
       ON b.passenger_id = p.passenger_id;

-- SHOW ONLY CONFIRMED BOOKINGS WITH PASSENGER DETAILS
SELECT 
p.full_name,p.age,p.gender,p.phone,p.email,p.address
FROM Travel_bookings b
INNER JOIN Passengers p
ON b.passenger_id = p.passenger_id;
...
------- Show all passengers
Select 
p.passenger_id,p.full_name,p.email,b.booking_status
From
Passengers p
left join 
Travel_Bookings b
...
--  List passengers who do not have any bookings
...
Where
	b.passenger_id is NUll
    
-- show passenger details booking with along seat number
...
--  Show passengers and their latest booking date 

Select p.full_name,b.booking_date
From Passengers p
Left join Travel_Bookings b
On p.passenger_id=b.passenger_id

	SELECT p.full_name, b.booking_status
	FROM Passengers p
	Left JOIN Travel_Bookings b
	ON p.passenger_id = b.passenger_id;
...
-- Prevent ordering a product with zero stock
...
-- Procedure: Place order automatically

DELIMITER $$
CREATE PROCEDURE place_order(IN uid INT, IN pid INT, IN qty INT)
BEGIN
    DECLARE price_val DECIMAL(10,2);

    SELECT price INTO price_val FROM Products WHERE product_id = pid;

    INSERT INTO Orders (user_id,total_amount,order_status)
    VALUES (uid, price_val * qty, 'Confirmed');

    INSERT INTO Order_Items (order_id,product_id,quantity,price)
    VALUES (LAST_INSERT_ID(), pid, qty, price_val);
END$$
DELIMITER ;
